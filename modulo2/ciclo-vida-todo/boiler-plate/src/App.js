...
class App extends React.Component {
  ...
  criaTarefa = () => {
    ...
    localStorage.setItem("lista", JSON.stringify(novaListaDeTarefas))

  }

  selectTarefa = (id) => {
    const maisRecenteListaDeTarefas = this.state.tarefas.map((tarefa) => {
      if (id === tarefa.id) {
        const novaTarefa = {
          ...tarefa,
    ...
    this.setState({ tarefas: maisRecenteListaDeTarefas})
  }
